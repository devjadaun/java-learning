...
✔ Conditional Statements (if, nested if, ternary)
✔ Logical & Arithmetic Operators
✔ User Input (Scanner)
✔ Switch & Enhanced Switch
...
* **IfStatement.java** → Basic decision making
* **NestedIf.java** → Multiple condition handling
* **TernaryOperator.java** → Short conditional logic
* **LogicalOperators.java** → AND, OR, NOT usage
* **EnhancedSwitch.java** → Modern switch syntax
